...
class AddressesController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	...
	public function listAction() {
		...
		// for preselect Glutenfreie Backereie
		if($this->settings['Glutenfreie']){
			$searchrecord['selectcheck'] = $this->settings['Glutenfreie'];
	  ...
	  //       }
			...
			if($mydata['GlutenfreiesBrot']){
				$searchrecord['selectcheck'] = $mydata['GlutenfreiesBrot'];
				$this->view->assign('ortaddresses', $searchrecord);
			}
		}
	}
